    ...
    <div className={classes.propertyDetailsAll}>
      ...
      <div style={{ marginTop: "1rem" }}>
        ...
        <p className={classes.terms}>
          You agree to PropertyWala's Terms of Use & Privacy Policy. By choosing
          to contact a property, you also agree that PropertyWalaGroup,
          ...
          automated means and prerecorded/artifhcial voices. You don't need to
          consent as acondition of renting any property, or buying any other
