					...
					<div className={classes.container}>
							...
							<input
								{...register("listerMobileNumber", {
									...
									pattern: {
										value: /^[6789]\d{9}$/,
										message:
											"please enter valid mobile number without +91",
									},
								})}
								type="tel"
							...
							<input
								{...register("yearBuilt", {
									...
									min: {
										value: 1900,
										message:
											"please enter valid year! min:1900",
									},
									max: {
										value: 2023,
						...
						<div className={classes.propertyLocation}>
							...
							>
								...
								<option value="studioApartment">
									Studio Apartment
								</option>
								<option value="serviceApartment">
									Service Apartment
								</option>
								<option value="office">
								...
								<option value="industrialBuilding">
									Industrial Building
								</option>
							...
							<input
								{...register("bedsNum", {
									...
									max: {
										value: 50,
										message:
											"you can only list upto 50 bedrooms",
									},
								})}
								type="number"
								name="bedsNum"
							...
							<input
								{...register("bathsNum", {
									...
									max: {
										value: 50,
										message:
											"you can only list upto 50 bathrooms",
									},
								})}
								type="number"
								name="bathsNum"
