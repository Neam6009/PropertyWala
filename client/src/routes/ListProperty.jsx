...
const ListProperty = () => {
  ...
  const propertyFormHandler = (data) => {
        ...
        >
          <div className={classes.container}>
            <div className={classes.personalDetails}>
              ...
              <select
                {...register("listerRelation", { required: true })}
                name="listerRelation"
                id="listerRelation"
              >
            ...
            <div className={classes.propertyDetails}>
              ...
              <input
                ...
                {...register("propertyPrice", {
                  ...
                  min: { value: 1000, message: "minimum price : 1000" },
                  max: 1000000000,
                })}
              ...
              <div>
                <select
                  {...register("propertyPurpose", { required: "required!" })}
                  id="propertyPurpose"
            ...
            <div className={classes.propertyLocation}>
              ...
              <input
                {...register("bedsNum", {
                  ...
                  min: { value: 0, message: "min : 0 bedrooms" },
                  max: {
                    value: 50,
              ...
              <input
                {...register("bathsNum", {
                  ...
                  min: { value: 0, message: "min : 0 bathrooms" },
                  max: {
                    value: 50,
